        ...
        <a-row>
          <a-col :span="15" style="text-align: left;">
            <a-form-item label="拜访时间" :labelCol="{span: 5}" :wrapperCol="{span:17}">
              <a-row>
                <a-col :span="12">
                  <j-date @change="changeValue" placeholder="请选择拜访开始时间" v-decorator="['visitingStarttime', validatorRules.visitingStarttime]" :trigger-change="true" :show-time="true" date-format="YYYY-MM-DD HH:mm:ss" style="width: 100%"/>
                </a-col>

                <a-col :span="12">
                  <j-date   placeholder="请选择拜访结束时间" v-decorator="['visitingEndtime', validatorRules.visitingEndtime]" :trigger-change="true" :show-time="true" date-format="YYYY-MM-DD HH:mm:ss" style="width: 100%"/>
                </a-col>
              </a-row>
            </a-form-item>
          </a-col>
          ...
          <a-col :span="24">
            <a-form-item label="拜访纪要" :labelCol="{span:3}" :wrapperCol="{span:20}">
              <a-textarea v-decorator="['visitSummary']" rows="3" placeholder="请输入拜访纪要"/>
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item label="拜访纪要" :labelCol="{span:3}" :wrapperCol="{span:20}">
              <a-textarea v-decorator="['visit2summary']" rows="3" placeholder="请输入拜访纪要"/>
            </a-form-item>
          </a-col>
