        ...
        <a-row>
          <a-col :span="12" >
            <a-form-item label="项目名称" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-dict-select-tag type="list" v-decorator="['projectName']" :trigger-change="true" dictCode="cshxmcj,project_name,id" placeholder="请选择项目名称"/>
            </a-form-item>
          </a-col>
          <a-col :span="12" >
            <a-form-item label="甲方单位名称" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-dict-select-tag type="list" v-decorator="['partaName']" :trigger-change="true" dictCode="cshxmcj,parta_name,id" placeholder="请选择甲方单位名称"/>
            </a-form-item>
          </a-col>
          <a-col :span="12" >
            <a-form-item label="甲方联系人" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-dict-select-tag type="list" v-decorator="['partaContactPerson']" :trigger-change="true" dictCode="cshxmcj,parta_person,id" placeholder="请选择甲方联系人"/>
            </a-form-item>
          </a-col>
          <a-col :span="12" >
          ...
          <a-col :span="12" >
            <a-form-item label="联系人角色" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-dict-select-tag type="list" v-decorator="['role']" :trigger-change="true" dictCode="cshxmcj,role,id" placeholder="请选择联系人角色"/>
            </a-form-item>
          </a-col>
          <a-col :span="12" >
